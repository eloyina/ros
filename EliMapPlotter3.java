...
public class EliMapPlotter3 extends JFrame implements Runnable {

	private String title = "Mapa recorrido por el robot";
	private String xAxisLabel = "Valores SLAM";
	private String yAxisLabel = "Valores Obtenidos ";

	private XYSeriesCollection path;

	private JFreeChart chart;

	public EliMapPlotter3() {
	...
	private JFreeChart createChart() {
		...
		NumberAxis rangeAxis2 = new NumberAxis(yAxisLabel);
		XYPlot subplot2 = new XYPlot(path, null, rangeAxis2, renderer2);
		subplot2.setRangeAxisLocation(AxisLocation.BOTTOM_OR_LEFT);

		XYTextAnnotation annotation = new XYTextAnnotation(
				"Punto de direccion", 50.0, 10000.0);
